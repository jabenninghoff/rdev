...
* Updated Get Started vignette with additional notes on replacing [RStudio](https://docs.posit.co/ide/user/#rstudio-ide-oss-downloads) with [Positron](https://github.com/posit-dev/positron)
