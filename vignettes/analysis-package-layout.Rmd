...
.Rprofile                |`x`|`x`| Used by `renv` and to [attach development tools](https://r-pkgs.org/setup.html?#personal-startup-configuration) and set project options
...
NEWS.md                  |   |`x`| Release notes, used by `get_release()`, [pkgdown](https://pkgdown.r-lib.org) and [Quarto](https://quarto.org)
