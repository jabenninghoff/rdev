...
LICENSE                  |`x`|`x`| Generated with [`use_mit_license()`](https://usethis.r-lib.org/reference/licenses.html)
...
README.Rmd               |`x`|`x`| Generated with [`use_readme_md()`](https://usethis.r-lib.org/reference/use_readme_rmd.html)
README.md                |`x`|`x`| Generated with [`build_readme()`](https://devtools.r-lib.org/reference/build_rmd.html)
...
docs                     |   |`x`| Used by [`build_analysis_site()`](https://jabenninghoff.github.io/rdev/reference/build_analysis_site.html) to render the R Package and Notebooks for GitHub Pages
