...
.lintr                   |   |`x`| [lintr](https://lintr.r-lib.org/index.html) default linters with 100 columns: `linters: with_defaults(line_length_linter(100))`
...
po                       |`x`|`x`| Used for [Internationalization](https://cloud.r-project.org/doc/manuals/r-devel/R-exts.html#Internationalization) if needed
