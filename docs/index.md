...
- Planned: [TODO](https://jabenninghoff.github.io/rdev/TODO.md)
...
3.  Without committing to git, run
...
7.  Re-run
    ...
    [`ci()`](https://jabenninghoff.github.io/rdev/reference/ci.md) to
    validate package
...
1.  Bump version and create new feature branch with
...
5.  Run
    ...
    to create a new pull request on GitHub using details derived from
    NEWS.md, including updating the README and GitHub pages
6.  After the pull request has been reviewed and passes all required
    status checks, accept the staged release with
...
[`stage_release()`](https://jabenninghoff.github.io/rdev/reference/stage_release.md)
just requires that everything is committed, including new release notes
in NEWS.md before running. When ready to release,
[`stage_release()`](https://jabenninghoff.github.io/rdev/reference/stage_release.md)
...
I also have a
[`ci()`](https://jabenninghoff.github.io/rdev/reference/ci.md) function
to run all my continuous integration tests locally:
...
#> 
#> ── R CMD check ─────────────────────────────────────────────────────────────────
#> * using log directory ‘/private/var/folders/vn/cw5f9gws42v9m8mdsds_zbl00000gp/T/Rtmp6LYrGk/file856023783c10/rdev.Rcheck’
